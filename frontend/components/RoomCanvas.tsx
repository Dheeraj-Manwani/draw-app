...
export function RoomCanvas() {
  ...
  // Ensure window-related code is executed only in the browser
  const canvasWidth = typeof window !== "undefined" ? window.innerWidth : 0; // Full width of the screen
  const canvasHeight = typeof window !== "undefined" ? window.innerHeight : 0; // Full height of the screen;
    ...
    <div>
      ...
      {action === "writing" ? (
        <textarea
          ref={textAreaRef}
          onBlur={handleBlur}
          className="fixed text-[24px] font-sans m-0 p-0 border-0 outline-0 overflow-hidden whitespace-pre bg-transparent z-2"
          style={{
            top: selectedElement
